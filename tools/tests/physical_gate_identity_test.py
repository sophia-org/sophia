...
class NativeReferenceDryRun(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # The runner records its call and executes the Sophia binary it was
        # handed, as the real one does; then it writes what the test's scenario
        # says this session produced and exits with the scenario's status. The
        # policy wrapper's hand-off records the digest it bound.
