...
reject_mutation events.0.log 's/status=added device=275 /status=added device=270 /; s/key_observed device=275/key_observed device=270/' 'a return under the removed identity'
reject_mutation events.0.log 's/status=added device=275 /status=added device=256 /; s/key_observed device=275/key_observed device=256/' 'a return under an identity seen before the unplug'
reject_mutation events.0.log '/key_observed device=275/d' 'a returned keyboard nobody typed on'
reject_mutation events.0.log 's/status=added device=275 keyboard=true pointer=false touch=false virtual=false/status=added device=275 keyboard=true pointer=false touch=false virtual=true/; s/status=added device=276 keyboard=true pointer=false touch=false virtual=false/status=added device=276 keyboard=true pointer=false touch=false virtual=true/' 'a return that was virtual'
