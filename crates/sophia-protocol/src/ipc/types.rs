...
pub enum IpcMessageKind {
    ...
    ShellOverviewBegin = 123,
    ShellOverviewWorkspace = 124,
    ShellOverviewEnd = 125,
    ShellOverviewRequest = 126,
    ShellOverviewCandidate = 127,
    ShellOverviewOutcome = 128,
