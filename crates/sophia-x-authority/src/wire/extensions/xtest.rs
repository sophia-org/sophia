fn decode_xtest(
    ...
    match bytes[1] {
        X_TEST_GET_VERSION_MINOR_OPCODE => {
            ...
            Ok(XWireRequest::XTest(crate::XTestRequest::XTestGetVersion {
        ...
        X_TEST_COMPARE_CURSOR_MINOR_OPCODE => {
            ...
            Ok(XWireRequest::XTest(crate::XTestRequest::XTestCompareCursor {
        ...
        X_TEST_FAKE_INPUT_MINOR_OPCODE => {
            ...
            Ok(XWireRequest::XTest(crate::XTestRequest::XTestFakeInput {
        ...
        X_TEST_GRAB_CONTROL_MINOR_OPCODE => {
            ...
            Ok(XWireRequest::XTest(crate::XTestRequest::XTestGrabControl {
                impervious: bytes[4],
            }))
        }
        ...
        minor_opcode => Ok(XWireRequest::XTest(crate::XTestRequest::XTestUnimplemented { minor_opcode })),
    }
}
