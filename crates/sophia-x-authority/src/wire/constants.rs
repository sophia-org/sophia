...
const X_SET_FONT_PATH: u8 = 51;
const X_GET_FONT_PATH: u8 = 52;
...
const X_COPY_COLORMAP_AND_FREE: u8 = 80;
const X_INSTALL_COLORMAP: u8 = 81;
const X_UNINSTALL_COLORMAP: u8 = 82;
const X_LIST_INSTALLED_COLORMAPS: u8 = 83;
const X_ALLOC_COLOR: u8 = 84;
const X_ALLOC_NAMED_COLOR: u8 = 85;
const X_LOOKUP_COLOR: u8 = 92;
const X_ALLOC_COLOR_CELLS: u8 = 86;
const X_ALLOC_COLOR_PLANES: u8 = 87;
const X_FREE_COLORS: u8 = 88;
const X_STORE_COLORS: u8 = 89;
const X_STORE_NAMED_COLOR: u8 = 90;
...
const X_QUERY_KEYMAP: u8 = 44;
const X_CHANGE_KEYBOARD_MAPPING: u8 = 100;
const X_SET_POINTER_MAPPING: u8 = 116;
const X_SET_MODIFIER_MAPPING: u8 = 118;
const X_CHANGE_SAVE_SET: u8 = 6;
const X_SET_CLOSE_DOWN_MODE: u8 = 112;
const X_KILL_CLIENT: u8 = 113;
const X_UNMAP_SUBWINDOWS: u8 = 11;
const X_CIRCULATE_WINDOW: u8 = 13;
const X_CHANGE_ACTIVE_POINTER_GRAB: u8 = 30;
const X_ROTATE_PROPERTIES: u8 = 114;
...
pub const X_KEYBOARD_LATCH_LOCK_STATE_MINOR_OPCODE: u8 = 5;
...
const X_WARP_POINTER_REQ_LEN: usize = 24;
...
const X_COPY_PLANE_REQ_LEN: usize = 32;
...
const X_QUERY_KEYMAP_REQ_LEN: usize = 4;
const X_CHANGE_KEYBOARD_MAPPING_REQ_LEN: usize = 8;
const X_SET_POINTER_MAPPING_REQ_LEN: usize = 4;
const X_SET_MODIFIER_MAPPING_REQ_LEN: usize = 4;
const X_CHANGE_SAVE_SET_REQ_LEN: usize = 8;
const X_SET_CLOSE_DOWN_MODE_REQ_LEN: usize = 4;
const X_KILL_CLIENT_REQ_LEN: usize = 8;
const X_UNMAP_SUBWINDOWS_REQ_LEN: usize = 8;
const X_CIRCULATE_WINDOW_REQ_LEN: usize = 8;
const X_CHANGE_ACTIVE_POINTER_GRAB_REQ_LEN: usize = 16;
const X_ROTATE_PROPERTIES_REQ_LEN: usize = 12;
...
const X_ALLOC_COLOR_CELLS_REQ_LEN: usize = 12;
const X_ALLOC_COLOR_PLANES_REQ_LEN: usize = 16;
const X_FREE_COLORS_REQ_LEN: usize = 12;
const X_STORE_COLORS_REQ_LEN: usize = 8;
const X_STORE_COLORS_ITEM_LEN: usize = 12;
const X_STORE_NAMED_COLOR_REQ_LEN: usize = 16;
...
const X_KEYBOARD_LATCH_LOCK_STATE_REQ_LEN: usize = 16;
