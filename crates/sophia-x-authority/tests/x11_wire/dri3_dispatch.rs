// DRI3 through dispatch: open, modifiers, pixmaps from buffers, fences,
// presentation of imported pixmaps, exports and backing. Included from
// x11_wire.rs beside core_dispatch.rs (t026).
