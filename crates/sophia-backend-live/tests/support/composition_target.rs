//! Shared deterministic target: real queue, lowering and custody; simulated copy/flip/device.
use super::*;
...
use std::io;
#[derive(Debug)]
pub(super) struct CopiedBacking {
    pub(super) bytes: Vec<u8>,
    pub(super) live: Rc<Cell<usize>>,
}
...
pub(super) struct Device {
    pub(super) destroyed: Cell<usize>,
    pub(super) failing: Cell<Option<u32>>,
}
