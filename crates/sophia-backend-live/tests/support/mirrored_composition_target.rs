...
use super::composition_test_target::{Device, copy_submission};
use super::*;
use crate::{
...
pub(super) struct Head {
    ...
    pub(super) prepared: Option<crate::BoxedRenderedPrimaryPlaneScanoutSubmission>,
    pub(super) content: Option<crate::LiveProductionScanoutContent>,
    pub(super) presented: Option<crate::LiveProductionScanoutContent>,
    pub(super) custody: crate::PersistentScanoutCustody,
    pub(super) frames: OutputFramePresentationState,
    pub(super) last_serial: u64,
    pub(super) history: crate::LiveRendererSlotDamageHistory,
}

pub(super) struct MirroredTarget {
    pub(super) owner: crate::NativeFrameOwner,
    pub(super) outputs: BTreeMap<OutputId, Vec<usize>>,
...
impl MirroredTarget {
    pub(super) fn new(outputs: &[HeadlessOutput]) -> Self {
    ...
    pub(super) fn settled_checksum(&self, output: OutputId) -> Option<u64> {
    ...
    pub(super) fn protected(&self, output: OutputId) -> bool {
    ...
    pub(super) fn ready(&self, output: OutputId) -> bool {
    ...
    pub(super) fn install(&mut self, output: OutputId) -> Result<(), &'static str> {
    ...
    pub(super) fn prepare(&mut self, output: OutputId) {
    ...
    pub(super) fn flip(&mut self, output: OutputId, sibling: usize) {
...
impl MirroredTarget {
    pub(super) fn queue_scene_batch(
        &mut self,
        frames: Vec<(OutputId, Vec<crate::LiveProductionHeadCompositionFrame>)>,
        required: &BTreeSet<OutputId>,
