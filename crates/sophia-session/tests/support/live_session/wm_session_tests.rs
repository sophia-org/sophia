...
include!("wm_session_tests/pointer_interaction.rs");
...
include!("wm_session_tests/snapshot_visibility.rs");
...
#[path = "../policy_output_ownership.rs"]
mod policy_output_ownership;

#[path = "../work_area_recovery.rs"]
